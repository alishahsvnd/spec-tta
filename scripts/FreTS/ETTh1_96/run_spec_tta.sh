...
#
# Usage: bash scripts/FreTS/ETTh1_96/run_spec_tta.sh <gpu> [k_bins] [beta_freq] [drift_thresh]
# Example: bash scripts/FreTS/ETTh1_96/run_spec_tta.sh 0 16 0.05 0.01
...
python -u main.py \
  ...
  TTA.ENABLE True \
  TTA.SOLVER.BASE_LR ${SPEC_LR} \
  TTA.SOLVER.WEIGHT_DECAY 0.0 \
