...
#
# Usage: bash scripts/iTransformer/ETTh1_96/run_spec_tta.sh <gpu> [k_bins] [beta_freq] [drift_thresh]
# Example: bash scripts/iTransformer/ETTh1_96/run_spec_tta.sh 0 16 0.05 0.01
